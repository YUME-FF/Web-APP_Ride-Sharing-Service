# Generated by Django 4.1.6 on 2023-02-07 03:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Vehicle_Type', models.CharField(choices=[('SUV', 'SUV'), ('COMPACT', 'COMPACT'), ('SEDAN', 'SEDAN'), ('COUPE', 'COUPE'), ('--', '--')], default='N/A', max_length=20)),
                ('Driver_License', models.CharField(default='', max_length=50)),
                ('Vehicle_Capacity', models.PositiveIntegerField(default=1)),
                ('Special_Information', models.CharField(blank=True, default='N/A', max_length=100)),
